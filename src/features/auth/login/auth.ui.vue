...
<template>
  <div
    class="bg-surface-0 dark:bg-surface-900 mx-auto flex w-full max-w-md flex-col gap-8 rounded-2xl p-8 shadow-sm md:p-12"
  >
    ...
    <Button
      class="mt-3 flex w-full items-center justify-center gap-2 rounded-lg py-2"
      icon="pi pi-user"
      label="Sign In"
      :loading="isPending"
      @click="login({ data: form })"
    >
      <template #icon>
