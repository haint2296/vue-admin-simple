...
export const getPostLoginResponseMock = (
  overrideResponse: Partial<PostLogin200> = {},
): PostLogin200 => ({
...
export const getPostLoginResponseMock200 = (
  overrideResponse: Partial<PostLogin200> = {},
): PostLogin200 => ({
  access_token: faker.string.alpha({ length: { min: 10, max: 20 } }),
  refresh_token: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getPostLoginResponseMock401 = (
  overrideResponse: Partial<PostLogin401> = {},
): PostLogin401 => ({
...
export const getPostLoginResponseMock500 = (
  overrideResponse: Partial<PostLogin500> = {},
): PostLogin500 => ({
  message: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
...
export const getPostLogoutResponseMock = (
  overrideResponse: Partial<PostLogout200> = {},
): PostLogout200 => ({
  message: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
...
export const getPostLogoutResponseMock200 = (
  overrideResponse: Partial<PostLogout200> = {},
): PostLogout200 => ({
  message: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getPostLogoutResponseMock401 = (
  overrideResponse: Partial<PostLogout401> = {},
): PostLogout401 => ({
  message: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
...
export const getPostLoginMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<PostLogin200> | PostLogin200),
) => {
...
export const getPostLoginMockHandler401 = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<PostLogin401> | PostLogin401),
) => {
  return http.post('*/login', async info => {
    await delay(1000)
...
export const getPostLoginMockHandler500 = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<PostLogin500> | PostLogin500),
) => {
  return http.post('*/login', async info => {
    await delay(1000)
...
export const getGetMeMockHandler401 = (
  overrideResponse?:
    | GetMe401
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<GetMe401> | GetMe401),
) => {
  return http.get('*/me', async info => {
    await delay(1000)
...
export const getGetMeMockHandler500 = (
  overrideResponse?:
    | GetMe500
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<GetMe500> | GetMe500),
) => {
  return http.get('*/me', async info => {
    await delay(1000)
...
export const getPostLogoutMockHandler = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<PostLogout200> | PostLogout200),
) => {
...
export const getPostLogoutMockHandler401 = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<PostLogout401> | PostLogout401),
) => {
  return http.post('*/logout', async info => {
    await delay(1000)
